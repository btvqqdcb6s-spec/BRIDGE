...
Methods:
  BRIDGE/CFRNet : informative, noisy, missing_weakest_1, missing_weakest_2

Workflow:
  1. python BRIDGE_tcga.py --rank-only
       Prints per-context leave-one-out Δvar rankings; no training.
  2. Fill in WEAKEST_GENES in the source file based on the output.
  3. python BRIDGE_tcga.py
...
# ----------------------------------------------------------------
# Run `python BRIDGE_tcga.py --rank-only` once to
