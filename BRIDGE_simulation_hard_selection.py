...
==================================================================
Uses synthetic block-diagonal MVN features instead of real TCGA expression data.
...
Features within each role block are correlated (rho_within=0.6).

Experiment: BRCA-only feature-subset sweep — how many context-specific features
does BRIDGE need to achieve good CATE estimation vs. CFRNet?
"""
...
# CFRNet-single architecture config for the BRCA-only feature-subset sweep.
...
# ============================================================
# 8. BRCA-only single-context sweep helpers
# ============================================================
